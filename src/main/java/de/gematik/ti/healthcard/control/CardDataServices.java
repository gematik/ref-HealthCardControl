...
public class CardDataServices {
    ...
    public CardDataServices(final HealthCard cardToRead, final HealthCard authorisingCard) {
     ...
     *
     * @return NfdDpeService
     */
    public NfdDpeService getNfdDpeService() {
        return new NfdDpeService(cardToRead, authorisingCard);
    }
    ...
    public VsdService getVsdService() {
        return new VsdService(cardToRead, authorisingCard);
    }
}
